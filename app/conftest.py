...
def another_site():
    return GlueSite(
        ...
        shares=[
            GlueShare(
                name=(
                    "Share in service https://example.com/v3_cloud.compute"
        ...
        "CloudComputingEndpoint": [
            {
                ...
                "DowntimeInfo": (
                    "https://goc.egi.eu/portal/index.php?Page_Type"
...
def glue_image():
    return {
        ...
        "MarketplaceURL": (
            "registry.egi.eu/egi_vm_images/ubuntu:22.04-sha256:"
